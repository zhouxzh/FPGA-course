<template><div><h1 id="第6讲-设计优化技术" tabindex="-1"><a class="header-anchor" href="#第6讲-设计优化技术"><span>第6讲：设计优化技术</span></a></h1>
<h2 id="_1-时序收敛方法论" tabindex="-1"><a class="header-anchor" href="#_1-时序收敛方法论"><span>1. 时序收敛方法论</span></a></h2>
<h3 id="_1-1-建立-保持时间约束" tabindex="-1"><a class="header-anchor" href="#_1-1-建立-保持时间约束"><span>1.1 建立/保持时间约束</span></a></h3>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">set_output_delay -clock clk </span><span style="--shiki-light:#986801;--shiki-dark:#D19A66">1</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF"> [get_ports data_out]</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-2-时钟域交叉分析" tabindex="-1"><a class="header-anchor" href="#_1-2-时钟域交叉分析"><span>1.2 时钟域交叉分析</span></a></h3>
<ul>
<li>同步器设计要点</li>
</ul>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-3-关键路径识别" tabindex="-1"><a class="header-anchor" href="#_1-3-关键路径识别"><span>1.3 关键路径识别</span></a></h3>
<div class="language-tcl line-numbers-mode" data-highlighter="shiki" data-ext="tcl" data-title="tcl" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">report_timing -slack_lesser_than </span><span style="--shiki-light:#986801;--shiki-dark:#D19A66">0</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF"> -nworst </span><span style="--shiki-light:#986801;--shiki-dark:#D19A66">10</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF"> -setup</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h3 id="_1-4-寄存器平衡技术" tabindex="-1"><a class="header-anchor" href="#_1-4-寄存器平衡技术"><span>1.4 寄存器平衡技术</span></a></h3>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">end</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-面积优化技巧" tabindex="-1"><a class="header-anchor" href="#_2-面积优化技巧"><span>2. 面积优化技巧</span></a></h2>
<h3 id="_2-1-资源共享-乘法器案例" tabindex="-1"><a class="header-anchor" href="#_2-1-资源共享-乘法器案例"><span>2.1 资源共享（乘法器案例）</span></a></h3>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-逻辑折叠技术" tabindex="-1"><a class="header-anchor" href="#_2-2-逻辑折叠技术"><span>2.2 逻辑折叠技术</span></a></h3>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">always</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF"> @(</span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">posedge</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF"> clk)</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">    result &#x3C;= (a &#x26; b) | (c ^ d);</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3-状态机编码优化" tabindex="-1"><a class="header-anchor" href="#_2-3-状态机编码优化"><span>2.3 状态机编码优化</span></a></h3>
<table>
<thead>
<tr>
<th>状态</th>
...
<h2 id="_3-功耗分析与优化" tabindex="-1"><a class="header-anchor" href="#_3-功耗分析与优化"><span>3. 功耗分析与优化</span></a></h2>
<h3 id="_3-1-功耗分析流程" tabindex="-1"><a class="header-anchor" href="#_3-1-功耗分析流程"><span>3.1 功耗分析流程</span></a></h3>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">report_power</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-时钟门控技术" tabindex="-1"><a class="header-anchor" href="#_3-2-时钟门控技术"><span>3.2 时钟门控技术</span></a></h3>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">    q &#x3C;= d;</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-3-vivado功耗工具" tabindex="-1"><a class="header-anchor" href="#_3-3-vivado功耗工具"><span>3.3 Vivado功耗工具</span></a></h3>
<ol>
<li>运行设计实现</li>
<li>打开Implemented Design</li>
<li>Report Power</li>
<li>分析静态/动态功耗分布</li>
</ol>
<h2 id="_4-设计约束规范" tabindex="-1"><a class="header-anchor" href="#_4-设计约束规范"><span>4. 设计约束规范</span></a></h2>
<h3 id="_4-1-sdc基本结构" tabindex="-1"><a class="header-anchor" href="#_4-1-sdc基本结构"><span>4.1 SDC基本结构</span></a></h3>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">set_multicycle_path </span><span style="--shiki-light:#986801;--shiki-dark:#D19A66">3</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF"> -setup -from [get_clocks clkA] -to [get_clocks clkB]</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-2-时序例外约束" tabindex="-1"><a class="header-anchor" href="#_4-2-时序例外约束"><span>4.2 时序例外约束</span></a></h3>
<table>
<thead>
<tr>
<th>约束类型</th>
...
<td>异步时钟域间路径</td>
<td>set_false_path -from clkA -to clkB</td>
</tr>
<tr>
<td>set_multicycle_path</td>
<td>慢速数据通路</td>
<td>set_multicycle_path 2 -hold -from regA</td>
</tr>
<tr>
<td>set_max_delay</td>
<td>特定路径约束</td>
<td>set_max_delay 5 -from [get_pins inst1/O]</td>
</tr>
</tbody>
</table>
<h3 id="_4-3-物理约束" tabindex="-1"><a class="header-anchor" href="#_4-3-物理约束"><span>4.3 物理约束</span></a></h3>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">place_cell inst_A RAMB3</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66">6</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">_X0Y5</span></span></code></pre>
