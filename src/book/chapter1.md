...
[1] Stephen Brown, Zvonko Vranesic. *Fundamentals of Digital Logic with Verilog Design*. McGraw-Hill.  

[2] Samir Palnitkar. *Verilog HDL: A Guide to Digital Design and Synthesis*. Prentice Hall.  

[3] Pong P. Chu. *FPGA Prototyping by Verilog Examples*. Wiley.  

[4] Wayne Wolf. *Modern VLSI Design: IP-Based Design*. Pearson.  

[5] AMD Xilinx. *7 Series FPGAs Configurable Logic Block User Guide*.  

[6] AMD Xilinx. *7 Series FPGAs Clocking Resources User Guide*.  

[7] Intel. *MAX Series Device Handbook*.  

[8] Intel. *FLEX 10K Embedded Programmable Logic Device Family Data Sheet*.  

[9] 夏宇闻.《Verilog 数字系统设计教程》. 北京航空航天大学出版社.  

[10] 王金明，杨吉斌.《数字系统设计——基于 FPGA 的方法》. 电子工业出版社.
