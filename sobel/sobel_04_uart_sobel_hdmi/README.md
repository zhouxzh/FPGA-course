...
```text
D:\Github\FPGA-course\sobel\sobel_04_uart_sobel_hdmi\sobel_04_uart_sobel_hdmi.xpr
```

如果需要重新生成 Block Design，在 Vivado Tcl Console 中执行：

```tcl
cd D:/Github/FPGA-course/sobel/sobel_04_uart_sobel_hdmi
...
```text
D:\Github\FPGA-course\sobel\sobel_04_uart_sobel_hdmi\sobel_04_uart_sobel_hdmi.sdk
```
...
```text
D:\Github\FPGA-course\sobel\host_camera_uart
```
