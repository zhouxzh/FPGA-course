...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Convert input_rgb.hex and sobel_out.pgm to directly viewable PNG images."
    )
    ...
    parser.add_argument("--sobel-pgm", type=Path, default=Path("data/sobel_out.pgm"))
    parser.add_argument("--input-png", type=Path, default=Path("data/input_rgb.png"))
    parser.add_argument("--sobel-png", type=Path, default=Path("data/sobel_out.png"))
