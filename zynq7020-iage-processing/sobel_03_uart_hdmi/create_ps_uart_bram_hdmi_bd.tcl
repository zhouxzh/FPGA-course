# Create the PS UART + AXI BRAM block design for step 3.
# HDMI logic stays in RTL top.v to avoid module-reference OOC IP conflicts.
#
# Run from Vivado Tcl Console after opening sobel_03_uart_hdmi.xpr:
#
...
set src_dir [file join $script_dir sobel_03_uart_hdmi.srcs sources_1 new]
...
proc remove_existing_bd_artifacts {bd_name script_dir} {
    ...
    foreach dir [list \
        [file join $script_dir sobel_03_uart_hdmi.srcs sources_1 bd $bd_name] \
        [file join $script_dir sobel_03_uart_hdmi.gen sources_1 bd $bd_name] \
        [file join $script_dir sobel_03_uart_hdmi.ip_user_files bd $bd_name] \
    ] {
        if {[file exists $dir]} {
